...
"""
UAV Server for exchanging data between rasspery PI and the ground station usign socket programming
...
and then the server repeats it for 2 reason :
    1 - Test the connection in terms of reliablitly
        ...
        -------------
            ...
            IV   - send the image key to the PI and wait for the response
                    if the response is IMG_ACK : 
                        ...
                        4 - Receive all the segments and concatunate them in one byte stream
