...
if os.name == "posix":
    cwd = "/media/raven/raven/yolo/QR/darknet/"
...
def load_model():
    ...
    network, class_names, class_colors_v = load_network('cfg/yolov4-tiny-3l.cfg', 'data/obj.data', 'backup/yolov4-tiny-3l_last.weights')
