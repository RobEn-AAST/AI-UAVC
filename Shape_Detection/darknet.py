...
if os.name == "posix":
    cwd = "/home/farah/AI-UAVC/Shape_Detection"
...
def load_model():
    ...
    network, class_names, class_colors_v = load_network(cwd + '/cfg/yolov4-tiny-3l-test.cfg', cwd + '/data/obj.data', cwd +'/backup/yolov4-tiny-3l_last.weights')
